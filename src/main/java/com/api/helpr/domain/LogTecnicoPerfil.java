...
@Entity
public class LogTecnicoPerfil implements Serializable {
	...
	public LogTecnicoPerfil() {
		super();
	}


	public LogTecnicoPerfil(Integer id, LocalDate dataAlteracao, String dadoAlterado, String dadoNovo,
			Integer devCorrecao) {
		super();
		this.id = id;
